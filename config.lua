...
maxPlayers = 0
serverName = "TPA Tibia Pirate Age"
serverMotd = "Welcome to the TPA Tibia Pirate Age!"
...
buyAolCommandFee = 20000
buyBlessCommandFee = 30
...
bossDefaultTimeToFightAgain = 1 * 60 * 60 -- 1 hours
bossDefaultTimeToDefeat = 5 * 60 -- 5 minutes
